        ...
        <div className="animate-fadeIn">
            ...
            {loading ? (
                ...
                <div className="glass-card p-12 text-center">
                    ...
                    <p className="text-[var(--text-muted)] mb-3">No medical records yet</p>
                    ...
                    <table className="data-table">
                        ...
                        <tbody>
                            {records.map((record) => (
                                <tr key={record._id}>
                                    <td>
                                        <p className="font-medium text-[var(--text-primary)]">{record.patientId.name}</p>
                                        <p className="text-sm text-[var(--text-secondary)]">{record.patientId.email}</p>
                                    </td>
                                    <td className="text-[var(--text-secondary)]">{record.diagnosis}</td>
                                    <td className="text-[var(--text-secondary)]">{formatDate(record.createdAt)}</td>
                                </tr>
                            ))}
                        </tbody>
                    </table>

                    ...
                    {filtered.map((patient) => (
                        <div key={patient._id} className="glass-card hoverable p-5">
                            ...
                            <div className="text-sm text-[var(--text-secondary)] space-y-1.5 mb-4">
                                <p className="flex items-center gap-1.5"><Phone className="w-3.5 h-3.5" /> {patient.phone}</p>
                                <p className="capitalize flex items-center gap-1.5"><UserCircle className="w-3.5 h-3.5" /> {patient.gender}</p>
                            </div>
